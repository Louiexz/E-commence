export class Result {
    constructor() {
        ...
        this.list = this.path.endsWith('produtos.html') ? 'foundProducts' : 'featuredProducts';
        this.div_name = this.path.endsWith('produtos.html') ? 'product_grid' : 'featured_grid';
        this.class_name = this.path.endsWith('produtos.html') ? 'product_box' : 'featured_box';
